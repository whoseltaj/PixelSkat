...
# PLAYER 1- MCTS , PLAYER 2- MCTS+NN, PLAYER 3 - MCTS : SELFPLAY F0R EXPERIMENT
...
from src.game.experiments.config1.state_config import interactive_bidding_phase
from src.game.experiments.config1.declarer_phase_config import interactive_declarer_phase
from src.game.experiments.config1.game_type_selection_config import select_game_type_entry
from src.game.state import evaluate_game_type, evaluate_suit_game
from src.game.experiments.config1.pygame_ui_config import run_ui
